...
func TestPublicIdentityService_GetUserByEmail_Success(t *testing.T) {
...
func TestPublicIdentityService_GetUserByEmail_UserNotFound(t *testing.T) {
	repo, _, svc := newPublicIdentityService(t)
